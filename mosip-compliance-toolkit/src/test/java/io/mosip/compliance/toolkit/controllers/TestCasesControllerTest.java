...
public class TestCasesControllerTest {
    ...
    public void generateRequestForSDKTest() throws Exception {
        ...
        Mockito.when(testCasesService.generateRequestForSDKTestcase(methodName, testcaseId, modalities)).thenReturn(response);
        Assert.assertEquals(response, testCasesController.generateRequestForSDK(methodName, testcaseId, modalities));
    }
