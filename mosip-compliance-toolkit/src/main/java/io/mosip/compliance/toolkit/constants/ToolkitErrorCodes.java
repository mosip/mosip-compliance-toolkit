...
public enum ToolkitErrorCodes {
	...
	INVALID_SBI_PROJECT_DETAILS("TOOLKIT_REQ_ERR_010", "SBI Project details is invalid"),
	ERROR_DELETING_SBI_PROJECT_DETAILS("TOOLKIT_REQ_ERR_011", "SBI Project details could not be deleted"),
