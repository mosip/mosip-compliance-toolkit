...
public enum ToolkitErrorCodes {
	...
	INVALID_PROJECT_NAME_OR_WEBSITE_URL("TOOLKIT_REQ_ERR_046", "Invalid characters or URL types are not allowed in project name or website URL"),
	INVALID_WEBSITE_URL("TOOLKIT_REQ_ERR_047", "Invalid website URL is not allowed"),
	INVALID_SDK_URL_OR_WEBSITE_URL("TOOLKIT_REQ_ERR_048", "Invalid URL is not allowed in base URL or website URL"),
	INVALID_ABIS_URL_OR_WEBSITE_URL("TOOLKIT_REQ_ERR_049", "Invalid URL is not allowed in activeMQ URL or website URL"),
	INVALID_COLLECTION_NAME("TOOLKIT_REQ_ERR_050", "Invalid characters are not allowed in collection name"),
	INVALID_FILE_SIZE("TOOLKIT_REQ_ERR_051", "File size is not allowed more than "),
	INVALID_FILE_NAME_LENGTH("TOOLKIT_REQ_ERR_052", "File name length is not allowed more than "),
	INVALID_FILE_NAME("TOOLKIT_REQ_ERR_053", "Invalid characters are not allowed in file name"),
	INVALID_COMMENTS("TOOLKIT_REQ_ERR_054", "Invalid characters are not allowed in comments"),
