...
public enum ToolkitErrorCodes {
	...
	INVALID_NAME("TOOLKIT_REQ_ERR_046", "Invalid characters are not allowed in "),
	INVALID_URL("TOOLKIT_REQ_ERR_047", "Invalid URL is not allowed in "),
	INVALID_FILE_SIZE("TOOLKIT_REQ_ERR_48", "File size is not allowed more than "),
	INVALID_FILE_NAME_LENGTH("TOOLKIT_REQ_ERR_049", "File name length is not allowed more than "),
	PROJECT_NAME("TOOLKIT_REQ_ERR_050", "project name"),
	BASE_URL("TOOLKIT_REQ_ERR_051", "base URL"),
	WEBSITE_URL("TOOLKIT_REQ_ERR_052", "website URL"),
	ACTIVE_MQ_URL("TOOLKIT_REQ_ERR_053", "active MQ URL"),
