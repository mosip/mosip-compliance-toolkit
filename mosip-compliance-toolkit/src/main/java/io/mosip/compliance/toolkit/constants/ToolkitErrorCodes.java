...
public enum ToolkitErrorCodes {
	...
	INVALID_COLLECTION_DETAILS("TOOLKIT_COLLECTIONS_005",
			"Unable to add a quality assessment collection because the collection details (Purpose, Device Type, or Device Sub Type) are invalid."),
	...
	COLLECTION_TYPE_EXISTS("TOOLKIT_DB_ERR_004", "You have previously created a collection with type: "),
