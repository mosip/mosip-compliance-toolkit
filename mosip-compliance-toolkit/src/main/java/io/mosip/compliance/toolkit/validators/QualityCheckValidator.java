            ...
            if (statusCode >= 200 && statusCode <= 299) {
                ...
                for (Entry<BiometricType, QualityScore> entry : entrySet) {
                    ...
                    if (Modalities.FINGER.getCode().equals(biometricTypeStr)) {
                        ...
                        validationResultDto.setDescriptionKey("QUALITY_CHECK_001" + AppConstants.NEW_DELIMITER + biometricTypeStr);
                    }
                }
            } else {
                if (inputDto.isNegativeTestCase() && (statusCode == 403 || statusCode == 406)) {
                    ...
                    validationResultDto.setDescriptionKey("QUALITY_CHECK_003" + AppConstants.NEW_DELIMITER + statusCode);
                }
            }
        } catch (Exception e) {
            validationResultDto.setStatus(AppConstants.FAILURE);
    ...
    private void checkScore(String biometricTypeStr, ValidationInputDto inputDto, float thresholdValue,
        ...
        if (!inputDto.isNegativeTestCase()) {
            ...
            if (score >= thresholdValue) {
                ...
                validationResultDto.setDescriptionKey("QUALITY_CHECK_004" + AppConstants.NEW_DELIMITER + biometricTypeStr);
            } else {
                validationResultDto.setStatus(AppConstants.FAILURE);
                ...
                validationResultDto.setDescriptionKey("QUALITY_CHECK_005" + AppConstants.NEW_DELIMITER + biometricTypeStr + "," + score);
            }
        } else {
            // negative test case
            if (score < thresholdValue) {
                ...
                validationResultDto.setDescriptionKey("QUALITY_CHECK_006" + AppConstants.NEW_DELIMITER + biometricTypeStr);
            } else {
                validationResultDto.setStatus(AppConstants.FAILURE);
                ...
                validationResultDto.setDescriptionKey("QUALITY_CHECK_007" + AppConstants.NEW_DELIMITER + biometricTypeStr + ":" + score);
            }
        }
    }
