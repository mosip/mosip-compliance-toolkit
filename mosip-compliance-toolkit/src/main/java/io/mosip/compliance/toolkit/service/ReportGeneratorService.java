...
public class ReportGeneratorService {
	...
	private VelocityContext populateVelocityAttributes(ReportRequestDto requestDto, String origin, String projectType,
		...
		if (ProjectTypes.SBI.getCode().equals(projectType)) {
			velocityContext.put("sbiProjectDetailsTable", getSbiProjectDetails(projectId));
		}
	...
	private SbiProjectTable getSbiProjectDetails(String projectId) {
		...
		if (sbiProjectResponse.getErrors().size() == 0) {
			...
			sbiProjectTable.setDeviceMake("TODO");
			sbiProjectTable.setDeviceModel("TODO");
			sbiProjectTable.setDeviceSerialNo("TODO");
			sbiProjectTable.setDeviceProvider("TODO");
			sbiProjectTable.setDeviceProviderId("TODO");
