...
public abstract class BioUtilValidator extends SBIValidator {
		...
		if (bioValue != null) {
			...
			default:
				...
				validationResultDto.setDescription(
						"BioUtilValidator failure - " + "with Message - " + " invalid bioType = " + bioType);
				break;
			}
		} else {
			validationResultDto.setStatus(AppConstants.FAILURE);
	...
	private ValidationResultDto isValidFingerISOTemplate(String purpose, String bioValue) {
		...
		if (!(compressionType == FingerImageCompressionType.JPEG_2000_LOSS_LESS
				|| compressionType == FingerImageCompressionType.JPEG_2000_LOSSY
	...
	private ValidationResultDto isValidIrisISOTemplate(String purpose, String bioValue) {
		...
		if (!(compressionType == IrisImageCompressionType.JPEG_LOSSLESS_OR_NONE
				|| compressionType == IrisImageCompressionType.JPEG_LOSSY)) {
