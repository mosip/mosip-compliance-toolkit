### -- ---------------------------------------------------------------------------------------------------------
### -- Script Name		: Compliance toolkit Release DB deploy
### -- Deploy Module 	: MOSIP Compliance Toolkit
### -- Purpose    		: To deploy Toolkit Database alter scripts for the release.       
### -- Create By   		: 
