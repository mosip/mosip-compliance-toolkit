...
ALTER TABLE toolkit.sbi_projects Add COLUMN device_images character varying(256);
ALTER TABLE toolkit.sbi_projects Add COLUMN make character varying(256);
ALTER TABLE toolkit.sbi_projects Add COLUMN model character varying(256);
ALTER TABLE toolkit.sbi_projects Add COLUMN sbi_hash character varying(256);
ALTER TABLE toolkit.sbi_projects Add COLUMN website_url character varying(256);
...
ALTER TABLE toolkit.sdk_projects Add COLUMN sdk_hash character varying(256);
ALTER TABLE toolkit.sdk_projects Add COLUMN website_url character varying(256);
...
ALTER TABLE toolkit.abis_projects Add COLUMN abis_hash character varying(256);
ALTER TABLE toolkit.abis_projects Add COLUMN website_url character varying(256);
