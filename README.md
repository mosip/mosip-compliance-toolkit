...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?branch=1.2.0&project=mosip_mosip-compliance-toolkit&metric=alert_status)](https://sonarcloud.io/dashboard?branch=1.2.0&id=mosip_mosip-compliance-toolkit)
